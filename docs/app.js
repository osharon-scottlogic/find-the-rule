        ...
        return (h("main", null,
            h("section", { class: "experiment" },
                ...
                h("form", { onSubmit: this.procFormAndCancelSubmit.bind(null, this.test), className: "testForm" },
                    h("input", { type: "number", value: state.val.a, onInput: this.updateVal.bind(null, 'a') }),
                    h("input", { type: "number", value: state.val.b, onInput: this.updateVal.bind(null, 'b') }),
                    h("input", { type: "number", value: state.val.c, onInput: this.updateVal.bind(null, 'c') }),
            ...
            h("section", { class: "hyposis" },
                h("h2", null, "3. Submit Your Hyposis"),
